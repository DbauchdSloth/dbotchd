...
module.exports.JoinEvent = (function(superclass) {
  ...
  function JoinEvent(channel, username) {
    ...
    return JoinEvent.__super__.constructor.apply(this, {channel: channel, username: username});
  }
  return JoinEvent;
})(Event);
...
module.exports.PartEvent = (function(superclass) {
  ...
  function PartEvent(channel, username) {
    ...
    return PartEvent.__super__.constructor.apply(this, {channel: channel, username: username});
  }
  return PartEvent;
})(Event);
...
module.exports.ChatEvent = (function(superclass) {
  ...
  function ChatEvent(channel, username, message) {
    ...
    return ChatEvent.__super__.constructor.apply(this, {channel: channel, username: username, message:message});
  }
  return ChatEvent;
})(Event);
...
module.exports.ActionEvent = (function(superclass) {
  ...
  function ActionEvent(channel, username, message) {
    ...
    return ActionEvent.__super__.constructor.apply(this, {channel: channel, username: username, message:message});
  }
  return ActionEvent;
})(Event);
...
module.exports.HostEvent = (function(superclass) {
  ...
  function HostEvent(channel, username, count) {
    ...
    return HostEvent.__super__.constructor.apply(this, {channel: channel, username: username, viewers:count});
  }
  return HostEvent;
})(Event);
